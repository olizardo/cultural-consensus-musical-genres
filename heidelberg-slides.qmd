...
-  Focused on the dual linkage between two systems of categories:
...
- Investigate folk schemas regarding the (explicit) associations between genre categories and categories of people
...
- Use relational techniques to extract the "backbone" of the perceived associations
  - Dual Projection**
  - Backbone extraction***
...
- Multiple **clouds of individuals**
  ...
  - Projected into label space (one cloud per label)
